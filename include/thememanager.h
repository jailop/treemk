...
public:
  ...
  enum class PreviewColorScheme { Auto, Light, Dark };
  ...
  EditorColorScheme currentEditorColorScheme() const {
    return m_currentEditorScheme;
  }
  PreviewColorScheme currentPreviewColorScheme() const {
    return m_currentPreviewScheme;
  }
