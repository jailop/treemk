...
inline const ThemeColors& getDarkTheme() {
    static ThemeColors dark{
        QColor(40, 40, 45),    QColor(50, 50, 55),    QColor(55, 50, 60),
        QColor(50, 47, 55),    QColor(60, 50, 65),    QColor(58, 48, 63),
        QColor(50, 65, 55),    QColor(70, 50, 55),    QColor(80, 100, 140),
        QColor(60, 60, 65),

        QColor(220, 215, 225), QColor(170, 165, 180), QColor(245, 245, 250),
        QColor(120, 120, 125),

        QColor(200, 180, 255), QColor(180, 200, 255), QColor(180, 200, 255),
        QColor(255, 160, 180), QColor(240, 180, 210), QColor(180, 220, 180),
        QColor(180, 180, 190), QColor(250, 230, 210), QColor(160, 160, 170),
        QColor(160, 240, 200), QColor(240, 150, 170), QColor(120, 120, 130),

        QColor(210, 180, 240), QColor(180, 220, 190), QColor(130, 130, 145),
        QColor(240, 200, 170), QColor(180, 200, 240), QColor(240, 210, 170),

        QColor(80, 80, 90),    QColor(85, 85, 95),    QColor(90, 90, 100),

        QColor(50, 50, 55),    QColor(220, 215, 225), QColor(40, 40, 45),
        QColor(50, 50, 55),    QColor(55, 55, 60),    QColor(220, 215, 225),
        QColor(120, 120, 125), QColor(130, 150, 210), QColor(255, 255, 255),
        QColor(35, 35, 40),    QColor(220, 215, 225),
...
inline QString toHexString(const QColor& color) { return color.name(); }
