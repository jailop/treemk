...
TreeMk is built on the pursuit of a powerful principle: _seamlessly integrating Markdown editing with file system navigation and doing both exceptionally well_.

Most Markdown editors treat your file system as an afterthought, hiding it behind proprietary vaults or databases. TreeMk takes the opposite approach—it embraces your file system as a first-class citizen. We combine a powerful Markdown editing approach with integrated file browsing, wiki-style linking, and rich navigation features, all working directly with your files, where they live.

### What Makes TreeMk Different
...
- Non-intrusive AI-assisted writing (prioritizing models running on your own computer)
- Beautiful live preview with LaTeX math, syntax highlighting, and diagram rendering

**File System Integration:**

- File browsing and navigation within the editor
- Wiki-links that work across your entire directory structure
- Drag & drop support to automatically generated and label wiki-links
- Backlinks panel showing document relationships
- Document outline for quick navigation within files
- Search across the files in your workspace
...
- **Version control**: Git provides comprehensive versioning, branching, and collaboration far beyond what any editor could build. Plain Markdown files integrate seamlessly with any version control system.
...
- **Advanced project management**: Full-featured PM tools offer complex workflow management. TreeMk while support task management, focuses on note-taking and document navigation.
...
Contributions that align with TreeMk's philosophy and scope are welcome:

- **Report bugs**: Help to make existing features more reliable
...
- **Improve the support for Windows and MacOS**: Because most development occurs on Linux and FreeBSD, more help is needed to improving the user experience and integration for Windows and macOS users.
- **Share your experience**: If you're using TreeMk, please share your experience with other users who could benefit from this tool.
