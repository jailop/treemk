...
void MainWindow::createActions() {
  newAction = new QAction(iconWithFallback("document-new", QStyle::SP_FileIcon),
                          tr("&New"), this);
  ...
  undoAction = new QAction(iconWithFallback("edit-undo", QStyle::SP_ArrowBack),
                           tr("&Undo"), this);
  ...
  pasteAction =
      new QAction(iconWithFallback("edit-paste", QStyle::SP_DialogApplyButton),
                  tr("&Paste"), this);
  ...
  findReplaceAction = new QAction(
      iconWithFallback("edit-find-replace", QStyle::SP_FileDialogDetailedView),
