...
AIAssistDialog::AIAssistDialog(QWidget* parent, const QString& selectedText,
                               int cursorPos, int selStart, int selEnd)
    : QDialog(parent),
...
AIAssistDialog::~AIAssistDialog() { delete ui; }

void AIAssistDialog::setupUI() {
    connect(ui->systemPromptCombo,
            QOverload<int>::of(&QComboBox::currentIndexChanged), this,
            &AIAssistDialog::onSystemPromptChanged);
    connect(ui->processButton, &QPushButton::clicked, this,
            &AIAssistDialog::processWithAI);
    connect(ui->applyButton, &QPushButton::clicked, this,
            &AIAssistDialog::applyToEditor);
    connect(ui->copyButton, &QPushButton::clicked, this,
            &AIAssistDialog::copyToClipboard);
    connect(ui->prevButton, &QPushButton::clicked, this,
            &AIAssistDialog::navigatePrevious);
    connect(ui->nextButton, &QPushButton::clicked, this,
            &AIAssistDialog::navigateNext);
    ...
    QShortcut* processShortcut =
        new QShortcut(QKeySequence("Ctrl+Return"), this);
    connect(processShortcut, &QShortcut::activated, this,
            &AIAssistDialog::processWithAI);
...
void AIAssistDialog::updateHistoryButtons() {
    ...
    if (historyStack.isEmpty()) {
        ...
        ui->historyLabel->setText(
            QString("%1/%2").arg(historyIndex + 1).arg(historyStack.size()));
    }
}
...
void AIAssistDialog::copyToClipboard() {
    ...
    QMessageBox::information(this, "AI Assist", "Content copied to clipboard.");
}
