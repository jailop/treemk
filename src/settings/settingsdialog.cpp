...
void SettingsDialog::setupMainTab() {
    ...
    linkSearchDepthSpinBox->setToolTip(
        tr("Maximum directory levels to search for linked files (up and down "
           "from current file)"));
    ...
    QLabel* shortcutsLabel = new QLabel(
        tr("Configure keyboard shortcuts for editor and application actions."));
...
void SettingsDialog::saveSettings() {
    ...
    settings.setValue("editor/lineBreakEnabled",
                      lineBreakCheckBox->isChecked());
    settings.setValue("editor/lineBreakColumns",
                      lineBreakColumnsSpinBox->value());
