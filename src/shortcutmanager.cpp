...
void ShortcutManager::initializeDefaults() {
    ...
    m_actionDescriptions[MoveToStartOfDocument] =
        tr("Move to Start of Document");
    ...
    m_shortcuts[DeleteToStartOfLine] =
    ...
    m_shortcuts[SwitchToPreviousTab] =
