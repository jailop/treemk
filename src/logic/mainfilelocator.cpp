...
const QStringList MainFileLocator::FALLBACK_NAMES = {"index.md", "README.md"};
...
QStringList MainFileLocator::getFallbackNames() { return FALLBACK_NAMES; }

QString MainFileLocator::findFile(const QString& folderPath,
